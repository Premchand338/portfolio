...
function Contact() {
  ...
  return (
    <section id="contact" className="w-full px-6 md:px-12 lg:px-20 py-8">
      {/* Success toast */}
      {showSuccess && (
      ...
      <div className="max-w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 bg-gray-950 rounded-2xl p-8 md:p-16">
        {/* Left side: info */}
        <div>
          ...
          <div className="flex flex-col gap-4 text-gray-300 py-5">
            <a
          ...
          <div className="mt-10 bg-gray-950/50 border border-white/70 rounded-xl p-4">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-transparent border rounded border-white/10 px-3 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-blue-400 transition-colors"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-transparent border rounded border-white/20 px-3 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-blue-400 transition-colors"
            />
          </div>

          <button
            type="submit"
            className="bg-linear-to-r from-blue-400 to-purple-500 hover:opacity-90 transition-opacity rounded-full py-3 font-semibold"
          >
            Send Message →
          </button>
